...
export class RatingCustomerController {
  static async createRating(req, res, next) {
    try {
      ...
      const rating = await RatingCustomerService.createRating({
        userId,
        payload: req.body,
      });
  ...
  static async updateRatingByOwner(req, res, next) {
    try {
      ...
      const rating = await RatingCustomerService.updateRatingByOwner({
        userId,
        ratingId,
        patch: req.body,
      });
  ...
  static async listMyRatings(req, res, next) {
    try {
      ...
      const data = await RatingCustomerService.listMyRatings({
        userId,
        page,
        limit,
        sort,
  ...
  static async getMyRatingById(req, res, next) {
    try {
      ...
      const rating = await RatingCustomerService.getMyRatingById({
        userId,
        ratingId: id,
      });
      res.json({ ok: true, rating });
