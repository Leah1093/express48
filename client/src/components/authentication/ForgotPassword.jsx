...
//   if (success) {
//     return (
//       <div className="w-full max-w-[600px] min-h-screen mx-auto flex flex-col items-center justify-start px-4 pt-[32px]">
//         <h2 className="font-rubik font-semibold text-[24px] leading-[120%] tracking-[-0.011em] text-center text-[#141414]">
//           בדוק את האימייל שלך
//         </h2>
//         <p className="mt-[12px] font-rubik font-normal text-[16px] leading-[120%] tracking-[-0.011em] text-center text-[#141414]">
//           <span className="font-semibold">{sentEmail}</span>  נשלח קישור לדוא״ל
//           <br />
//           .לחץ כדי לאמת את חשבונך
//         </p>

//         <div className="flex flex-row-reverse items-center justify-center gap-2 mt-[48px]">
//           <p className="text-[16px] font-rubik text-[#141414]">?לא קיבלת אימייל</p>
//           <button
//             type="button"
//             onClick={() => setSuccess(false)}
//             className="text-[#FF6500] font-rubik text-[16px] hover:cursor-pointer mr-3"
//           >
//             שלח שוב
//           </button>
//         </div>
...
//       <div className="w-full mt-[12px] flex justify-center">
